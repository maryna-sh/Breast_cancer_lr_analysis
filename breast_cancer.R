...
# -- finding y_hat
predicted_probability <- predict(caic_model, 
...
#library(gridExtra)
#grid.arrange(a,b,c,d,f,e, nrow=2)
# to arrange all the plots, but for the reason of aesthetics, I will 
# re-do the code to arrange it nicely
...
# Conclusion.
# 
# We have studied different measures typically used to test a patient for breast cancer.
# We have built a logistic regression model, using these measures, and seen that it works well classifying values. We made sure we have built the most efficient model with the help of backwards elimination and AIC score through step() function. 
